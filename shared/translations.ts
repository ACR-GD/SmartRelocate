...
export const translations: Record<string, Translation> = {
  en: {
    ...
    perfectForExploringOptions: "Perfect for exploring Malaysia visa options",
    oneTime: "One-time payment",
    professionalPlanDescription: "Best for serious Malaysia relocators",
    fullService: "Full-service Malaysia relocation package",
    currentPlan: "Current Plan",
    getPdfGuide: "Get PDF Guide",
    selectPlan: "Select Plan",
    recommended: "Recommended",
    chooseYourRelocationPlan: "Choose Your Malaysia Relocation Plan",
    fromBasicGuidanceToFullService: "From basic guidance to full-service Malaysia relocation support",
    
    // Pricing Features
    basicVisaEligibility: "Malaysia visa eligibility check",
    aiChatGuidance: "AI-powered Malaysia guidance",
    countryComparisonTool: "Malaysia comparison tool",
    basicCostEstimates: "Malaysia cost estimates",
    communityForumAccess: "Malaysia expat community access",
    unlimitedAiAssessments: "Unlimited Malaysia visa assessments",
    pdfExportChecklist: "Malaysia relocation checklist PDF",
    detailedVisaRequirements: "Detailed Malaysia visa requirements",
    priorityAiChatResponses: "Priority AI chat responses",
    emailSupport: "Email support",
    unlimitedAiAssessmentsLabel: "Unlimited Malaysia visa assessments",
    relocationBudgetCalculator: "Malaysia budget calculator",
    savedRelocationProfiles: "Saved Malaysia profiles",
    visaStatusAlerts: "Malaysia visa status alerts",
    taxPlanningGuidance: "Malaysia tax planning guidance",
    oneOnOneConsultation: "One-on-one Malaysia consultation",
    documentPreparationService: "Malaysia visa document prep",
    visaApplicationAssistance: "Malaysia visa application help",
    bankAccountSetupGuidance: "Malaysia bank setup guidance",
    housingJobSearchSupport: "Malaysia housing & job search",
    dedicatedRelocationManager: "Dedicated Malaysia manager",
  ...
  fr: {
    ...
    perfectForExploringOptions: "Parfait pour explorer les options de visa Malaisie",
    oneTime: "Paiement unique",
    professionalPlanDescription: "Idéal pour les relocalisateurs sérieux vers la Malaisie",
    fullService: "Package service complet Malaisie",
  ...
  ar: {
    ...
    perfectForExploringOptions: "مثالية لاستكشاف خيارات فيزا ماليزيا",
    oneTime: "دفعة واحدة",
    professionalPlanDescription: "الأفضل للمنتقلين الجادين إلى ماليزيا",
    fullService: "حزمة الخدمة الكاملة لماليزيا",
